...
public class TestaSort {
    public static void main(String[] args) {
        ...
        Cliente c = new Cliente("José", Long.valueOf("00000100100"));//OBS se vc colocar somente 1 e 0
        Cliente c1 = new Cliente("Juca", Long.valueOf("01000100010"));//O construtor interpreta como binário
